...
export default function GcashHome() {
  ...
  useEffect(() => {
    // Generate a random balance between 1000 and 50000 on mount
    const randomAmount = (Math.random() * (50000 - 1000) + 1000).toFixed(2);
          ...
          <SafeAreaView>
            <View style={styles.headerTop}>
              <View style={styles.profileSection}>
                <Image source={require('../assets/leon.jpg')} style={styles.profilePic} />
                <View style={styles.greeting}>
                  <Text style={styles.greetingText}>Leon S. Kennedy</Text>
                </View>
              </View>
            ...
            <View style={styles.balanceSection}>
              <TouchableOpacity style={styles.balanceRow} onPress={toggleBalance}>
                ...
                <Icon name={isBalanceVisible ? "eye-outline" : "eye-off-outline"} size={16} color="#fff" style={{ marginLeft: 5 }} />
              </TouchableOpacity>
              <View style={styles.balanceAmountRow}>
                <Text style={styles.currencySymbol}>₱</Text>
                <Text style={isBalanceVisible ? styles.balanceText : styles.dots}>
...
const styles = StyleSheet.create({
  ...
  greetingText: { color: '#fff', fontSize: 16, fontWeight: 'bold' },
  ...
  balanceText: { color: '#fff', fontSize: 28, fontWeight: 'bold', marginLeft: 2 },
